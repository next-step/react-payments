...
function App() {
    ...
    return (
        <div className="app">
            ...
            <Card cardNumber={cardNumber} name={name} cardExpireDate={expireDate}></Card>
            <div className="input-container">
                <span className="input-title">카드 번호</span>
                <div className="input-box">
                    <NumberInput className={"input-basic"} type={"text"} maxLength={4} inputChange={(value) => handleCardNumberChange(value, 'first')}></NumberInput>
                    <span>-</span>
                    <NumberInput className={"input-basic"} type={"text"} maxLength={4} inputChange={(value) => handleCardNumberChange(value, 'second')}></NumberInput>
                    <span>-</span>
                    <NumberInput className={"input-basic"} type={"password"} maxLength={4} inputChange={(value) => handleCardNumberChange(value, 'third')}></NumberInput>
                    <span>-</span>
                    <NumberInput className={"input-basic"} type={"password"} maxLength={4} inputChange={(value) => handleCardNumberChange(value, 'fourth')}></NumberInput>
                </div>
            </div>
            <div className="input-container">
                ...
                <div className="input-box w-50">
                    <NumberInput className={"input-basic"}
                                 type={"text"}
                                 placeHolder={"MM"}
                                 inputRule={(value) => /^(0?\d|1[0-2])?$/.test(value)}
