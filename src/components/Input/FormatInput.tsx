...
import { INPUT_COLOR, INPUT_FONT_SIZE, INPUT_FONT_WEIGHT, UpdateValueProps, InputType } from '@/components/Input';
import type { StyleProps } from '@/shared';
import { styleToken, Box, HStack, Label, TextField, Typography } from '@/shared';
...
export const FormatInput = ({
  ...
  const { values, updateValue } = useInputFieldsValues(defaultValue, onValueChange, onValueComplete);
